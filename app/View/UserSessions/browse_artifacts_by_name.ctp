<?php 
	...
	echo $this->Html->script('browse_artifacts_by_name',FALSE);
?>

<?php $this->extend('navigation'); ?>
<h2>Search artifacts - by name</h2>
<?php echo $this->Html->link("Browse artifacts by function",
array('controller' => 'user_sessions', 'action' => 'browse_artifacts_by_function', $UserSession['UserSession']['id'])); ?>
<br/>
<br/>
