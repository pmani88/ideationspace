<?php 
	...
	echo $this->Html->script('search_triz_by_feature',FALSE);
	
	echo $this->Html->script('auto_add_solutions',array('inline' => false));
?>

<?php $this->extend('navigation'); ?>
<h2>Triz - by feature</h2>
<?php echo $this->Html->link("Search by function",
array('controller' => 'user_sessions', 'action' => 'search_triz_by_function', $UserSession['UserSession']['id'], $pid)); ?>
<br/>
<br/>
