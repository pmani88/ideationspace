<?php 
	...
	echo $this->Html->script('browse_physical_effects_by_name',FALSE);
...
<h3>Field</h3>
<div>
<input type="radio" name="field" id="mechanical" value="mechanical"> Mechanical<br>
<input type="radio" name="field" id="electrical" value="electrical"> Electrical<br>
<input type="radio" name="field" id="thermal_fluid" value="thermal_fluid"> ThermalFluid
</div>
